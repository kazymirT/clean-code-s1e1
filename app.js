...
var addButton=document.querySelector(".task-new__btn");//first button
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task__list-label';
    ...
    editInput.classList.add("task__list-task");
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task__list-edit");
    ...
    listItem.classList.toggle("task__list-edit");
};
